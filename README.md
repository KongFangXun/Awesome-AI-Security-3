...
|![][code]|[sofagent - Open-source harness for governing AI coding agents: 24 commit-time audit rules over git diffs, HMAC-signed audit trail, snapshot rollback, a full MCP toolset](https://github.com/KongFangXun/sofagent)|
